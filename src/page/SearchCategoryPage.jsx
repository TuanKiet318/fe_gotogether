...
import { GetAllCategories, GetPlacesByCategory } from "../service/api.admin.service.jsx";
import { HomeIcon, FireIcon, ShoppingBagIcon, MapIcon, UsersIcon, MapPinIcon, ShoppingCartIcon } from '@heroicons/react/24/outline';
                    ...
                    {categories.map((cat) => {
                        ...
                        return (
                            <button
                                ...
                                onClick={() =>
                                    navigate(
                                        `/category/${cat.id}?q=${encodeURIComponent(searchLocation)}`
                                    )
                                }
