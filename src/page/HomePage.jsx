  ...
  const howItWorksSteps = [
    {
      ...
      description:
        "Khám phá những địa điểm, nhà hàng và điểm tham quan thú vị cho chuyến đi của bạn.",
    },
    {
      icon: Calendar,
      title: "Lên kế hoạch ngày",
      description:
        "Sắp xếp các điểm đến thành lịch trình từng ngày với gợi ý thông minh.",
    },
    {
      icon: Map,
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">
              Hãy để những điểm đến tuyệt vời này truyền cảm hứng cho bạn và bắt
              đầu hành trình sắp tới.
            </p>
          </motion.div>
