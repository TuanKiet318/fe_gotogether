  ...
  return (
    <>
      ...
      >
          ...
          <div className="container-custom h-full">
            <div className="flex items-center justify-between h-full">
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  <div
                    className={`w-7 h-7 bg-gradient-to-r from-sky-500 to-indigo-600 rounded-lg flex items-center justify-center ${isTransparent ? "shadow-lg" : "shadow-sm"
                      }`}
                  >
                    <MapPin className="w-3.5 h-3.5 text-white" />
                  </div>
                  <span
                    className={`text-lg font-extrabold bg-gradient-to-r from-sky-600 to-indigo-700 bg-clip-text ${isTransparent ? "text-white" : "text-transparent"
        ...
        <div
          ref={mobileMenuRef}
          className={`fixed top-0 left-0 h-full w-64 bg-white shadow-xl z-50 transform transition-transform duration-300 ease-in-out md:hidden ${isMobileMenuOpen ? "translate-x-0" : "-translate-x-full"
            }`}
        >
